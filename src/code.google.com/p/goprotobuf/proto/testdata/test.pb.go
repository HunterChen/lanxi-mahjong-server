...
type GoEnum struct {
	Foo              *FOO   `protobuf:"varint,1,request,name=foo,enum=testdata.FOO" json:"foo,omitempty"`
...
type GoTestField struct {
	Label            *string `protobuf:"bytes,1,request" json:"Label,omitempty"`
	Type             *string `protobuf:"bytes,2,request" json:"Type,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type GoTest struct {
	...
	Kind  *GoTest_KIND `protobuf:"varint,1,request,enum=testdata.GoTest_KIND" json:"Kind,omitempty"`
	Table *string      `protobuf:"bytes,2,opt" json:"Table,omitempty"`
	Param *int32       `protobuf:"varint,3,opt" json:"Param,omitempty"`
	// Required, repeated and optional foreign fields.
	RequiredField *GoTestField   `protobuf:"bytes,4,request" json:"RequiredField,omitempty"`
	...
	// Required fields of all lib types
	F_BoolRequired    *bool    `protobuf:"varint,10,request,name=F_Bool_required" json:"F_Bool_required,omitempty"`
	F_Int32Required   *int32   `protobuf:"varint,11,request,name=F_Int32_required" json:"F_Int32_required,omitempty"`
	F_Int64Required   *int64   `protobuf:"varint,12,request,name=F_Int64_required" json:"F_Int64_required,omitempty"`
	F_Fixed32Required *uint32  `protobuf:"fixed32,13,request,name=F_Fixed32_required" json:"F_Fixed32_required,omitempty"`
	F_Fixed64Required *uint64  `protobuf:"fixed64,14,request,name=F_Fixed64_required" json:"F_Fixed64_required,omitempty"`
	F_Uint32Required  *uint32  `protobuf:"varint,15,request,name=F_Uint32_required" json:"F_Uint32_required,omitempty"`
	F_Uint64Required  *uint64  `protobuf:"varint,16,request,name=F_Uint64_required" json:"F_Uint64_required,omitempty"`
	F_FloatRequired   *float32 `protobuf:"fixed32,17,request,name=F_Float_required" json:"F_Float_required,omitempty"`
	F_DoubleRequired  *float64 `protobuf:"fixed64,18,request,name=F_Double_required" json:"F_Double_required,omitempty"`
	F_StringRequired  *string  `protobuf:"bytes,19,request,name=F_String_required" json:"F_String_required,omitempty"`
	F_BytesRequired   []byte   `protobuf:"bytes,101,request,name=F_Bytes_required" json:"F_Bytes_required,omitempty"`
	F_Sint32Required  *int32   `protobuf:"zigzag32,102,request,name=F_Sint32_required" json:"F_Sint32_required,omitempty"`
	F_Sint64Required  *int64   `protobuf:"zigzag64,103,request,name=F_Sint64_required" json:"F_Sint64_required,omitempty"`
	// Repeated fields of all lib types
	...
	// Optional fields of all lib types
	...
	// Default-valued fields of all lib types
	...
	Requiredgroup           *GoTest_RequiredGroup   `protobuf:"group,70,request,name=RequiredGroup" json:"requiredgroup,omitempty"`
...
type GoTest_RequiredGroup struct {
	RequiredField    *string `protobuf:"bytes,71,request" json:"RequiredField,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type GoTest_RepeatedGroup struct {
	RequiredField    *string `protobuf:"bytes,81,request" json:"RequiredField,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type GoTest_OptionalGroup struct {
	RequiredField    *string `protobuf:"bytes,91,request" json:"RequiredField,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type GoSkipTest struct {
	SkipInt32        *int32                `protobuf:"varint,11,request,name=skip_int32" json:"skip_int32,omitempty"`
	SkipFixed32      *uint32               `protobuf:"fixed32,12,request,name=skip_fixed32" json:"skip_fixed32,omitempty"`
	SkipFixed64      *uint64               `protobuf:"fixed64,13,request,name=skip_fixed64" json:"skip_fixed64,omitempty"`
	SkipString       *string               `protobuf:"bytes,14,request,name=skip_string" json:"skip_string,omitempty"`
	Skipgroup        *GoSkipTest_SkipGroup `protobuf:"group,15,request,name=SkipGroup" json:"skipgroup,omitempty"`
	XXX_unrecognized []byte                `json:"-"`
}
...
type GoSkipTest_SkipGroup struct {
	GroupInt32       *int32  `protobuf:"varint,16,request,name=group_int32" json:"group_int32,omitempty"`
	GroupString      *string `protobuf:"bytes,17,request,name=group_string" json:"group_string,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type InnerMessage struct {
	Host             *string `protobuf:"bytes,1,request,name=host" json:"host,omitempty"`
...
type MyMessage struct {
	Count     *int32               `protobuf:"varint,1,request,name=count" json:"count,omitempty"`
...
type MessageList_Message struct {
	Name             *string `protobuf:"bytes,2,request,name=name" json:"name,omitempty"`
	Count            *int32  `protobuf:"varint,3,request,name=count" json:"count,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type FloatingPoint struct {
	F                *float64 `protobuf:"fixed64,1,request,name=f" json:"f,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
