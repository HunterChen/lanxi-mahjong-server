...
type UninterpretedOption_NamePart struct {
	NamePart         *string `protobuf:"bytes,1,request,name=name_part" json:"name_part,omitempty"`
	IsExtension      *bool   `protobuf:"varint,2,request,name=is_extension" json:"is_extension,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
