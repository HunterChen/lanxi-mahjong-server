...
type Instruction interface {
	...
	// Block returns the lib block to which this instruction
	// belongs.
	Block() *BasicBlock

	// setBlock sets the lib block to which this instruction belongs.
	setBlock(*BasicBlock)
...
type Function struct {
	...
	Locals    []*Alloc
	Blocks    []*BasicBlock // lib blocks of the function; nil => external
...
// a lib type, possibly one of the "untyped" types, or a slice type
...
// Type().  One or both of those types is lib (but possibly named).
//
...
type anInstruction struct {
	block *BasicBlock // the lib block of this instruction
}
