...
flattening of a lib type is a list containing a single node.)
...
single node: lib types, pointers, channels, maps, slices, 'func'
pointers, interfaces.
...
Basic types (bool, string, numbers, unsafe.Pointer)
  ...
  non-pointer lib types such as int, are represented in objects and
  ...
  All other lib types are ignored.  Expressions of these types have
