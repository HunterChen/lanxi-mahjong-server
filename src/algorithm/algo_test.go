...
func TestExist(t *testing.T) {
	...
	var thirteen = existThirteen(cs3,0)
	t.Log("thirteen -> ", fmt.Sprintf("%b", thirteen))
...
func Test_zuhe(t *testing.T) {
	...
	cards = []byte{ 0x11, 0x12, 0x13, 0x14, 0x15, 0x26, 0x17, 0x18, 0x19, 0x19}
	//11 12 13  53 14 15 13 23 24 27 27
	v := existHu(cards, []uint32{}, []uint32{EncodePeng(1,0x11)}, []uint32{}, 0, 0x19)
