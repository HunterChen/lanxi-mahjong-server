...
// The example above shows the most lib use of a Manager.
...
// Limits
//
// To avoid hitting lib rate limits on LetsEncrypt.org, a given Manager limits all its
...
// Web Servers
//
// The lib requirement for use of a Manager is that there be an HTTPS server
