...
// Trade Result notify response message from weixin pay
// Refer to http://pay.weixin.qq.com/wiki/doc/api/app.php?chapter=9_7&index=3
...
func (this *TradeResult) ToMap() map[string]string {
	retMap, err := ToMap(this)
	if err != nil {
		panic(err)
	}
...
func ParseTradeResult(resp []byte) (TradeResult, error) {
	...
	err := xml.Unmarshal(resp, &tradeResult)
	if err != nil {
